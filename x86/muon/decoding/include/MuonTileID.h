...
namespace CPUMuon {
  ...
  public:
    MuonTileID(unsigned int muonid) { m_muonid = muonid; }
    ...
    unsigned int region() const { return (m_muonid & ::Muon::MuonBase::MaskRegion) >> ::Muon::MuonBase::ShiftRegion; }
    ...
    unsigned int nX() const { return (m_muonid & ::Muon::MuonBase::MaskX) >> ::Muon::MuonBase::ShiftX; }

    unsigned int nY() const { return (m_muonid & ::Muon::MuonBase::MaskY) >> ::Muon::MuonBase::ShiftY; }

    void setX(const unsigned int x) { set(x, ::Muon::MuonBase::ShiftX, ::Muon::MuonBase::MaskX); }

    void setY(const unsigned int y) { set(y, ::Muon::MuonBase::ShiftY, ::Muon::MuonBase::MaskY); }
