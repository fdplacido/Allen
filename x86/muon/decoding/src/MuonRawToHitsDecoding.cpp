...
void muonRawToHitsDecode(gsl::span<char> events, gsl::span<unsigned int> offsets,
  ...
  muonRawToHitsDecode(events, offsets, muon_hits_events, &muonRawToHits);
}
...
void muonRawToHitsDecode(gsl::span<char> events, gsl::span<unsigned int> offsets,
  ...
  muonRawToHitsDecode(events, offsets, muon_hits_events, muon_table_raw_input, muon_geometry_raw_input);
}
