...
namespace SciFi {
  namespace LookingForward {
    ...
    constexpr float ds_p_param_inv[12] = 
      {1.f/1080.88, 1.f/1076.73, 1.f/1112.94, 1.f/1081.53, 1.f/1090.73, 1.f/1085.53, 1.f/1086.62, 1092.9, 1.f/1108.92, 1.f/1109.86, 1.f/1110.35, 1.f/1107.57};
