...
There is a working branch which compiles and runs on the AMD GPU [v5 here](https://gitlab.cern.ch/lhcb-parallelization/Allen/tree/Brij-Carlos-Allen-HIP-v5-working)
