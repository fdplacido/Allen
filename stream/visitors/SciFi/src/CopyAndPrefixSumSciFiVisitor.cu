  ...
  cudaEvent_t& cuda_generic_event)
{
  if (runtime_options.cpu_offload) {
    ...
    cudaCheck(cudaMemcpyAsync(
      ...
      (uint*) arguments.offset<dev_scifi_lf_x_filtered_atomics>() + host_buffers.host_number_of_selected_events[0],
      (uint*) arguments.offset<dev_scifi_lf_x_filtered_atomics>(),
    ...
    state.set_arguments(
      ...
      // (uint*) arguments.offset<dev_atomics_scifi>(),
      // (uint*) arguments.offset<dev_atomics_scifi>() + host_buffers.host_number_of_selected_events[0],
      (uint*) arguments.offset<dev_scifi_lf_x_filtered_atomics>() + host_buffers.host_number_of_selected_events[0] * 2,
      (uint*) arguments.offset<dev_scifi_lf_x_filtered_atomics>(),
      (uint*) arguments.offset<dev_scifi_lf_x_filtered_atomics>() + host_buffers.host_number_of_selected_events[0],
    ...
    cudaCheck(cudaMemcpyAsync(
      ...
      arguments.offset<dev_scifi_lf_x_filtered_atomics>() + host_buffers.host_number_of_selected_events[0] * 2,
      sizeof(uint),
