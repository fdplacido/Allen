  ...
  cudaEvent_t& cuda_generic_event)
{
  ...
  //SciFi::Hits hi(host_scifi_hits, host_scifi_hit_count[host_buffers.host_number_of_selected_events[0] * SciFi::Constants::n_mats], &host_geom, constants.host_inv_clus_res.data());
