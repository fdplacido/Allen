// #include "LFFormSeedsFromFirstLayerWindow.cuh"
// #include "SequenceVisitor.cuh"

// template<>
// void SequenceVisitor::set_arguments_size<lf_form_seeds_from_first_layer_window_t>(
//   lf_form_seeds_from_first_layer_window_t::arguments_t arguments,
...
// template<>
// void SequenceVisitor::visit<lf_form_seeds_from_first_layer_window_t>(
//   lf_form_seeds_from_first_layer_window_t& state,
//   const lf_form_seeds_from_first_layer_window_t::arguments_t& arguments,
//   const RuntimeOptions& runtime_options,
//   const Constants& constants,
...
//   state.set_opts(dim3(host_buffers.host_number_of_selected_events[0]), dim3(1, LookingForward::lf_form_seeds_from_first_layer_window_y_threads), cuda_stream);
//   state.set_arguments(
