...
ARGUMENT(dev_multi_final_vertices, PV::Vertex)
ARGUMENT(dev_number_of_multi_final_vertices, uint)
...
ARGUMENT(dev_pvtracks_denom, float)
ARGUMENT(dev_pvtrack_z, float)