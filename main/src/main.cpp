...
int main(int argc, char* argv[])
{
  ...
  const std::string folder_name_forward_tracks = "/home/dvombruc/Allen/input/test/forward_tracks";
  read_folder(folder_name_forward_tracks, number_of_events_requested, events_tracks, event_tracks_offsets, start_event_offset);
  std::vector<Checker::Tracks> forward_tracks = read_forward_tracks(events_tracks.data(), event_tracks_offsets.data(), number_of_events_requested); 
