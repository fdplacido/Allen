...
namespace MuonBase {
  ...
  static const unsigned int BitsKey   = BitsIndex + BitsReadout + BitsLayer + BitsStation;
  //
  ...
  //
  static const ContentType MaskX       = ( ( ( (ContentType)1 ) << BitsX ) - 1 ) << ShiftX;
  static const ContentType MaskY       = ( ( ( (ContentType)1 ) << BitsY ) - 1 ) << ShiftY;
  static const ContentType MaskRegion  = ( ( ( (ContentType)1 ) << BitsRegion ) - 1 ) << ShiftRegion;
  static const ContentType MaskQuarter = ( ( ( (ContentType)1 ) << BitsQuarter ) - 1 ) << ShiftQuarter;
  static const ContentType MaskLayoutX = ( ( ( (ContentType)1 ) << BitsLayoutX ) - 1 ) << ShiftLayoutX;
  static const ContentType MaskLayoutY = ( ( ( (ContentType)1 ) << BitsLayoutY ) - 1 ) << ShiftLayoutY;
  static const ContentType MaskReadout = ( ( ( (ContentType)1 ) << BitsReadout ) - 1 ) << ShiftReadout;
  static const ContentType MaskLayer   = ( ( ( (ContentType)1 ) << BitsLayer ) - 1 ) << ShiftLayer;
  static const ContentType MaskStation = ( ( ( (ContentType)1 ) << BitsStation ) - 1 ) << ShiftStation;
  //
  static const ContentType MaskIndex = ( ( ( (ContentType)1 ) << BitsIndex ) - 1 ) << ShiftIndex;
  static const ContentType MaskKey   = ( ( ( (ContentType)1 ) << BitsKey ) - 1 ) << ShiftKey;
